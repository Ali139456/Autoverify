...
export function ReportShell({
  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-200/60">
      <header className="flex items-start justify-between gap-6 bg-[#0073E3] px-6 py-5 sm:px-8">
        <div>
          <Image
      ...
      <footer className="flex items-center justify-between border-t border-slate-200 px-6 py-4 sm:px-8">
        <Image
